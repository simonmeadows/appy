...
<ul class="sidebar-menu" data-widget="tree">
  <div class="sidebar-menu" v-permission.if="[USER_ROLES.ADMIN]">
    <li class="header">SPECTRUM</li>
    <router-link tag="li" class="pageLink" to="/spectrum" v-permission.enable="['user', 'readUser']">
      <a>
          <i class="fa fa-user"></i>
          <span class="page">Spectrum</span>
        </a>
    </router-link>
    <router-link tag="li" class="pageLink" to="/eventlist" v-permission.enable="['user', 'readUser']">
      <a>
          <i class="fa fa-user"></i>
          <span class="page">Events List</span>
        </a>
    </router-link>
    <router-link tag="li" class="pageLink" to="/scannerlist" v-permission.enable="['user', 'readUser']">
      <a>
          <i class="fa fa-user"></i>
          <span class="page">Scanner List</span>
        </a>
    </router-link>
    <router-link tag="li" class="pageLink" to="/scanlist" v-permission.enable="['user', 'readUser']">
      <a>
          <i class="fa fa-user"></i>
          <span class="page">Scan List</span>
        </a>
    </router-link>
